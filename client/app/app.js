...
angular
    .module('arkclient', ['ngMaterial', 'md.data.table', 'gettext', 'monospaced.qrcode',
      'arkclient.accounts', 'arkclient.addressbook', 'arkclient.pluginLoader', 'arkclient.coreServices', 'arkclient.coreUtils', 'arkclient.qrScanner'])
