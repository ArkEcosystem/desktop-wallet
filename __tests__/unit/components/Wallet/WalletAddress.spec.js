...
describe('WalletAddress', () => {
  ...
  it('should display Second Signature for type 1', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.SECOND_SIGNATURE')
    )
  })
  ...
  it('should display Delegate Registration for type 2', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.DELEGATE_REGISTRATION')
    )
  })
  ...
  it('should display Vote for type 3', () => {
    const wrapper = mount({
      address: 'dummyAddress',
      type: 3,
      asset: { votes: ['+dummyAddress'] }
    })

    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.VOTE')
    )
  })
  ...
  it('should display Unvote for type 3', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.UNVOTE')
    )
  })
  ...
  it('should display Multi Signature for type 4', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.MULTI_SIGNATURE')
    )
  })
  ...
  it('should display IPFS for type 5', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.IPFS')
    )
  })
  ...
  it('should display Timelock Transfer for type 6', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.TIMELOCK_TRANSFER')
    )
  })
  ...
  it('should display Multi Payment for type 7', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.MULTI_PAYMENT')
    )
  })
  ...
  it('should display Delegate Resignation for type 8', () => {
    ...
    expect(wrapper.text()).toEqual(
      expect.stringContaining('TRANSACTION.TYPE.DELEGATE_RESIGNATION')
    )
  })
})
