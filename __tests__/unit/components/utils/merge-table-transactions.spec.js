...
describe("Utils > mergeTableTransactions", () => {
	...
	describe("when there are duplicates", () => {
		it("should not return duplicates", () => {
			...
			expect(mergeTableTransactions(a, b)).toEqual([transactions[2], transactions[5], transactions[0]]);
		});
		...
		it("should priorize the first `Array`", () => {
			...
			expect(mergeTableTransactions(a, b)).toEqual([transactions[2], transactions[5], a[0]]);
		});
	});
});
