...
describe("TransactionFormBusinessRegistration", () => {
	...
	it("should have business registration transaction type", () => {
	...
	describe("methods", () => {
		describe("buildTransaction", () => {
			it("should build business registration", async () => {
			...
			it("should build business registration with default arguments", async () => {
				const transactionData = {
					type: 0,
					typeGroup: 2,
				};
