...
describe("TransactionConfirmDelegateRegistration", () => {
	...
	describe("template", () => {
		...
		it("should output senderLabel", () => {
			expect(
				wrapper
					.find(".TransactionConfirmDelegateRegistration__sender .ListDividedItem__value span:first-child")
					.text(),
		...
		it("should output username", () => {
			expect(
				wrapper.find(".TransactionConfirmDelegateRegistration__username .ListDividedItem__value").text(),
			).toBe("test_delegate");
		});
	});
