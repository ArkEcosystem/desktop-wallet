...
var ImageManager = /** @class */ (function () {
    ...
    Object.defineProperty(ImageManager, "svg", {
        /**
    ...
    Object.defineProperty(ImageManager.prototype, "images", {
        get: function () {
    ...
    Object.defineProperty(ImageManager.prototype, "tree", {
        // Make an object with the categories in the key,
        // and filenames as child. Eg: { textures: [...] }
        get: function () {
            return this.images.reduce(function (acc, img) {
                var path = img.replace('./', '');
                var _a = path.split('/'), category = _a[0], filename = _a[1];
                if (category && filename) {
                    var previous = acc[category] || [];
                    acc[category] = __spreadArrays(previous, [
                        category + "/" + filename
                    ]);
                }
                return acc;
    ...
    ImageManager.prototype.inline = function () {
        var filter = [];
    ...
    ImageManager.prototype.loadImage = function (filename) {
...
if (process.env.NODE_ENV !== 'test') {
    ...
    var svgs = require.context('../assets/svg', true, /\.svg$/);
