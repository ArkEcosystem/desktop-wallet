...
var MultiPaymentBuilder = /** @class */ (function () {
    function MultiPaymentBuilder() {
    }
    MultiPaymentBuilder.build = function (_a, isAdvancedFee, returnObject) {
        var address = _a.address, recipients = _a.recipients, fee = _a.fee, vendorField = _a.vendorField, passphrase = _a.passphrase, secondPassphrase = _a.secondPassphrase, wif = _a.wif, networkWif = _a.networkWif, multiSignature = _a.multiSignature, nonce = _a.nonce;
        if (isAdvancedFee === void 0) { isAdvancedFee = false; }
        if (returnObject === void 0) { returnObject = false; }
        return __awaiter(this, void 0, void 0, function () {
            var staticFee, transaction, _i, recipients_1, recipient;
            return __generator(this, function (_b) {
                if (!store.getters['session/network'].constants.aip11) {
                    throw new Error('AIP-11 transaction not supported on network');
                }
                staticFee = store.getters['transaction/staticFee'](TRANSACTION_TYPES.GROUP_1.MULTI_PAYMENT, 1);
...
export { MultiPaymentBuilder };
//# sourceMappingURL=multi-payment.builder.js.map