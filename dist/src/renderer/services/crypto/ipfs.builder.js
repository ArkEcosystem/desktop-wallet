...
var IpfsBuilder = /** @class */ (function () {
    function IpfsBuilder() {
    }
    IpfsBuilder.build = function (_a, isAdvancedFee, returnObject) {
        var address = _a.address, fee = _a.fee, hash = _a.hash, passphrase = _a.passphrase, secondPassphrase = _a.secondPassphrase, wif = _a.wif, networkWif = _a.networkWif, multiSignature = _a.multiSignature, nonce = _a.nonce;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                staticFee = store.getters['transaction/staticFee'](TRANSACTION_TYPES.GROUP_1.IPFS, 1);
...
export { IpfsBuilder };
//# sourceMappingURL=ipfs.builder.js.map