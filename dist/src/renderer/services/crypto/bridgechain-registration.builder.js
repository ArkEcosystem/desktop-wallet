...
var BridgechainRegistrationBuilder = /** @class */ (function () {
    function BridgechainRegistrationBuilder() {
    }
    BridgechainRegistrationBuilder.build = function (_a, isAdvancedFee, returnObject) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                staticFee = store.getters['transaction/staticFee'](TRANSACTION_TYPES.GROUP_2.BRIDGECHAIN_REGISTRATION, 2);
                if (!isAdvancedFee && fee.gt(staticFee)) {
                    throw new Error("Bridgechain Registration fee should be smaller than " + staticFee);
                }
                transaction = new MagistrateCrypto.Builders.BridgechainRegistrationBuilder()
    ...
    return BridgechainRegistrationBuilder;
}());
export { BridgechainRegistrationBuilder };
//# sourceMappingURL=bridgechain-registration.builder.js.map