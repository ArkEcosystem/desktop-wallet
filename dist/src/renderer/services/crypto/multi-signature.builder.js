...
var MultiSignatureBuilder = /** @class */ (function () {
    function MultiSignatureBuilder() {
    }
    MultiSignatureBuilder.build = function (_a, isAdvancedFee, returnObject) {
        var address = _a.address, publicKeys = _a.publicKeys, minKeys = _a.minKeys, fee = _a.fee, passphrase = _a.passphrase, secondPassphrase = _a.secondPassphrase, wif = _a.wif, networkWif = _a.networkWif, nonce = _a.nonce;
        if (isAdvancedFee === void 0) { isAdvancedFee = false; }
        if (returnObject === void 0) { returnObject = false; }
        return __awaiter(this, void 0, void 0, function () {
            var staticFee, transaction, transactionObject;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        staticFee = store.getters['transaction/staticFee'](TRANSACTION_TYPES.GROUP_1.MULTI_SIGNATURE, 1);
                        ...
                        return [4 /*yield*/, TransactionSigner.sign({
                                address: address,
...
export { MultiSignatureBuilder };
//# sourceMappingURL=multi-signature.builder.js.map