...
var BridgechainUpdateBuilder = /** @class */ (function () {
    function BridgechainUpdateBuilder() {
    }
    BridgechainUpdateBuilder.build = function (_a, isAdvancedFee, returnObject) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                staticFee = store.getters['transaction/staticFee'](TRANSACTION_TYPES.GROUP_2.BRIDGECHAIN_UPDATE, 2);
                if (!isAdvancedFee && fee.gt(staticFee)) {
                    throw new Error("Bridgechain Update fee should be smaller than " + staticFee);
                }
                transaction = new MagistrateCrypto.Builders.BridgechainUpdateBuilder()
    ...
    return BridgechainUpdateBuilder;
}());
export { BridgechainUpdateBuilder };
//# sourceMappingURL=bridgechain-update.builder.js.map