...
var BusinessRegistrationBuilder = /** @class */ (function () {
    function BusinessRegistrationBuilder() {
    }
    BusinessRegistrationBuilder.build = function (_a, isAdvancedFee, returnObject) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var staticFee, businessRegistrationAsset, transaction;
            return __generator(this, function (_b) {
                if (!store.getters['session/network'].constants.aip11) {
                    throw new Error('AIP-11 transaction not supported on network');
                }
                staticFee = store.getters['transaction/staticFee'](TRANSACTION_TYPES.GROUP_2.BUSINESS_REGISTRATION, 2);
                ...
                transaction = new MagistrateCrypto.Builders.BusinessRegistrationBuilder()
    ...
    return BusinessRegistrationBuilder;
}());
export { BusinessRegistrationBuilder };
//# sourceMappingURL=business-registration.builder.js.map