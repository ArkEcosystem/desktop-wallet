...
var VoteBuilder = /** @class */ (function () {
    function VoteBuilder() {
    }
    VoteBuilder.build = function (_a, isAdvancedFee, returnObject) {
        var address = _a.address, votes = _a.votes, fee = _a.fee, passphrase = _a.passphrase, secondPassphrase = _a.secondPassphrase, wif = _a.wif, networkWif = _a.networkWif, multiSignature = _a.multiSignature, nonce = _a.nonce;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                staticFee = store.getters['transaction/staticFee'](TRANSACTION_TYPES.GROUP_1.VOTE, 1);
...
export { VoteBuilder };
//# sourceMappingURL=vote.builder.js.map