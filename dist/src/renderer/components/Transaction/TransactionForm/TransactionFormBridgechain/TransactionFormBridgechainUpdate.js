...
export default {
    ...
    mounted: function () {
        ...
        this.form.seedNodes = this.bridgechain.seedNodes.map(function (ip) { return ({
            ip: ip,
            isInvalid: false
        }); });
    ...
    methods: {
        buildTransaction: function (transactionData, isAdvancedFee, returnObject) {
            if (isAdvancedFee === void 0) { isAdvancedFee = false; }
            if (returnObject === void 0) { returnObject = false; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.$client.buildBridgechainUpdate(transactionData, isAdvancedFee, returnObject)];
                });
            });
        },
...
//# sourceMappingURL=TransactionFormBridgechainUpdate.js.map