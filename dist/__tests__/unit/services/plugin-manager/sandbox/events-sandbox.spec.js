...
describe('Events Sandbox', function () {
    var app;
    var walletApi;
    beforeEach(function () {
        walletApi = {};
    ...
    describe('on', function () {
        it('should enable and trigger event', function () { return __awaiter(void 0, void 0, void 0, function () {
            var eventTriggerMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        eventTriggerMock = jest.fn();
                        walletApi.eventBus.on('test:event', eventTriggerMock);
                        expect(eventTriggerMock).toHaveBeenCalledTimes(0);
                        return [4 /*yield*/, app.$eventBus.emit('test:event')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, app.$eventBus.emit('test:event')];
                    case 2:
        ...
        it('should allow regex', function () { return __awaiter(void 0, void 0, void 0, function () {
            var eventTriggerMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expect(eventTriggerMock).toHaveBeenCalledTimes(0);
                        return [4 /*yield*/, app.$eventBus.emit('test:event:1')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, app.$eventBus.emit('test:event:2')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, app.$eventBus.emit('test:event:3')];
                    case 3:
                        _a.sent();
                        expect(eventTriggerMock).toHaveBeenCalledTimes(3);
                        return [2 /*return*/];
    ...
    describe('off', function () {
        it('should disable event', function () { return __awaiter(void 0, void 0, void 0, function () {
            var eventTriggerMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should disable regex', function () { return __awaiter(void 0, void 0, void 0, function () {
            var eventTriggerMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('destroy', function () {
        it('should clear all events', function () { return __awaiter(void 0, void 0, void 0, function () {
            var eventTriggerMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
//# sourceMappingURL=events-sandbox.spec.js.map