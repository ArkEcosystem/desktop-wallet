...
jest.mock('fs', function () { return ({
    readFileSync: jest.fn(function () { return JSON.stringify({
        locale: 'new-language',
...
var setupLanguage = function (language) {
...
describe('i18n > i18n-setup', function () {
    var spyMessages;
    var spyNumberFormats;
    var spyDateTimeFormats;
    beforeEach(function () {
    ...
    describe('setLanguage', function () {
        ...
        it('should set the given language', function () {
            var newLocale = 'new-language';
            expect(i18n.locale).not.toBe(newLocale);
            i18nSetup.setLanguage(newLocale);
            expect(i18n.locale).toBe(newLocale);
        });
        it('should unload other languages', function () {
            var newLocale = 'new-language';
    ...
    describe('unloadLanguage', function () {
        it('should unload a language', function () {
            setupLanguage(language);
            expect(i18n.getLocaleMessage(language.locale)).toEqual(language.messages);
    ...
    describe('loadLanguage', function () {
        it('should return early if no pluginLanguage is given', function () {
            expect(i18nSetup.loadLanguage(language.locale)).toBe(undefined);
        });
        it('should return early if the current locale is the given language', function () {
            expect(i18nSetup.loadLanguage(language.locale, {})).toBe(undefined);
        });
        it('should load the language if it isn\'t loaded already', function () {
            var newLocale = 'new-language';
        ...
        it('should not load the language if it is loaded already', function () {
            var newLocale = 'en-US';
...
//# sourceMappingURL=i18n-setup.spec.js.map