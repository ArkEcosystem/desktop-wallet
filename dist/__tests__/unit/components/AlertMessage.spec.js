...
describe('AlertMessage', function () {
    ...
    it('should queue alert with different duration', function () {
        wrapper.vm.queueAlert({
            message: 'TEST ALERT',
            type: 'success',
            duration: 10000
    ...
    it('should have duration property and be a number', function () {
        var duration = wrapper.vm.$options.props.duration;
        expect(duration).toBeObject();
        expect(duration.type).toBe(Number);
        expect(duration.default).toBe(5000);
    });
});
//# sourceMappingURL=AlertMessage.spec.js.map