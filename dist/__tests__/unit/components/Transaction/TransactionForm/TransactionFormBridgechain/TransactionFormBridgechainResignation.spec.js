...
var createWrapper = function (component, wallet, bridgechain) {
    ...
    wrapper = mount(component, {
        ...
        mocks: {
            $client: {
                buildBridgechainResignation: jest.fn(function (transactionData) { return transactionData; })
            },
            $error: jest.fn(),
            $store: {
                getters: {
...
describe('TransactionFormBridgechainResignation', function () {
    beforeEach(function () {
            ...
            it('should be disabled if form is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            expect(wrapper.find('.TransactionFormBridgechainResignation__next').attributes('disabled')).toBe('disabled');
                            return [2 /*return*/];
                    }
                });
            }); });
            ...
            it('should build business resignation', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            response = _a.sent();
                            expect(wrapper.vm.$client.buildBridgechainResignation).toHaveBeenCalledWith(transactionData, true, true);
            ...
            it('should build business resignation with default arguments', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            response = _a.sent();
                            expect(wrapper.vm.$client.buildBridgechainResignation).toHaveBeenCalledWith(transactionData, false, false);
                            expect(response).toBe(transactionData);
                            return [2 /*return*/];
                    }
                });
...
//# sourceMappingURL=TransactionFormBridgechainResignation.spec.js.map