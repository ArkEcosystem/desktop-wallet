...
var createWrapper = function (component, wallet, delegate) {
    ...
    wrapper = mount(component, {
        ...
        mocks: {
            $client: {
                buildDelegateResignation: jest.fn(function (transactionData) { return transactionData; })
            },
            $error: jest.fn(),
            $store: {
                getters: {
                    'delegate/byAddress': jest.fn(function () { return delegate; }),
...
describe('TransactionFormDelegateResignation', function () {
    beforeEach(function () {
        createWrapper();
    });
    it('should have delegate resignation transaction type', function () {
    ...
    describe('computed', function () {
        describe('username', function () {
            ...
            it('should return null if not a delegate', function () {
                createWrapper(null, null, null);
                expect(wrapper.vm.username).toBe(null);
            });
        });
        describe('canResign', function () {
            it('should return true if delegate and has username', function () {
            ...
            it('should return false if no username', function () {
                createWrapper(null, {
                    isDelegate: true
                }, {});
                expect(wrapper.vm.canResign).toBe(false);
    ...
    describe('methods', function () {
        ...
        describe('buildTransaction', function () {
            it('should build delegate resignation', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should build delegate resignation with default arguments', function () { return __awaiter(void 0, void 0, void 0, function () {
                var transactionData, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
...
//# sourceMappingURL=TransactionFormDelegateResignation.spec.js.map