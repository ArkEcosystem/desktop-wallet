...
describe('WalletBusinessBridgechainsTable', function () {
    beforeEach(function () {
        createWrapper();
    });
    ...
    it('should include TableWrapper component', function () {
    ...
    describe('computed columns', function () {
        ...
        it('should format seed nodes as quantity', function () {
            var seeds = [
                1,
                2,
                3,
        ...
        it('should format genesis hash as truncated', function () {
            var genesisHash = '123456789012345678901234567890';
            expect(wrapper.vm.columns[2].formatFn(genesisHash)).toBe(truncateMiddle(genesisHash, 14));
        });
    });
    it('should show WalletBusinessShowBridgechain if selected row', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('onSortChange', function () {
        it('should emit on-sort-change', function () {
    ...
    describe('onRowClick', function () {
        it('should update selected row', function () {
            var fakeTransaction = { type: 1 };
    ...
    describe('onCloseModal', function () {
        it('should close reset selected row & close modal', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wrapper.vm.selected = { type: 1 };
...
//# sourceMappingURL=WalletBusinessBridgechainsTable.spec.js.map