...
describe('WalletIpfs', function () {
    ...
    it('should include WalletTransactions component', function () {
        expect(wrapper.contains('.WalletTransactions')).toBe(true);
    });
    describe('closeTransactionModal', function () {
        it('should toggle method if open', function () {
...
//# sourceMappingURL=WalletIpfs.spec.js.map