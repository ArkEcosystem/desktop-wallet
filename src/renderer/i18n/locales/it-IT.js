export default {
  ...
  INTRODUCTION: {
    ...
    TURN: {
      ...
      CONCLUSION:
        "Tutti qui, al team di ARK.io, speraiamo ti piacerà utilizzare l'ARK Desktop Wallet e partecipare nella rivoluzione blockchain!"
    }
  },
  ...
  APP_SIDEMENU_NOTIFICATION: {
    NOTIFICATION:
      'Una nuova versione ({version}) è stata rilasciata. Aggiorna ora!',
    ...
    PROFILE_NEW: {
      STEP1: {
        INSTRUCTIONS: {
          ...
          TEXT:
            'Inserisci il tuo nome o nickname e seleziona la lingua preferita e la valuta predefinita.'
        },
        NAME: 'Nome profilo',
  ...
  WALLET_TRANSACTIONS: {
    ...
    AMOUNT: 'Importo',
    NEW_TRANSACTIONS:
      'Questo portafoglio ha {count} nuova/e transazione/i. Premi il pulsante ricarica per aggiornare.'
  },
