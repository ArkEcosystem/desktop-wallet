export default {
	...
	MODAL_EXPORT_WALLETS: {
		...
		INSTRUCTIONS:
			"<b>Important:</b> Your exported wallets will not contain your passphrases, only the addresses and respective names will be saved!",
		OPTIONS: {
	...
	MODAL_PLUGIN_URL: {
		...
		DISCLAIMER:
			"<b>Disclaimer:</b> Please make sure to check the documentation of the plugin before installing it. By installing it on your wallet, you assume every responsibility.",
	},
	...
	PAGES: {
		...
		PLUGIN_MANAGER: {
			...
			DISCLAIMER:
				"<b>Disclaimer:</b> The availability of this plugin in the ARK Desktop Wallet does not mean that either ARK.io or ARK SCIC is directly involved in the development or affiliated with the developer providing this plugin. By installing it on your wallet, you assume every responsibility.",
	...
	TRANSACTION: {
		...
		ERROR: {
			...
			NOT_ENOUGH_BALANCE:
				"The total amount of the recipients + fee is greater than the balance ({balance}) of the wallet",
		...
		FOOTER_TEXT: {
			...
			BRIDGECHAIN_RESIGNATION:
				"Keep in mind that you cannot restore your bridgechain after the resignation has been registered on the blockchain.",
		},
		INFO: {
		...
		BRIDGECHAIN: {
			...
			INVALID_SEEDS:
				"You have an invalid seed node - please check it is up and running correctly | You have invalid seed nodes - please check they are up and running correctly",
		},
		WARNING: {
		...
		CONFIRM_SEND_ALL:
			"This will enable sending all of your tokens from the current wallet in this transaction. The selected transfer fee will be deducted from the send amount.",
	...
	PLUGIN_BLACKLIST_CONFIRMATION: {
		NOTE:
			"By blacklisting the plugin it will be disabled on all profiles and will no longer appear in the Plugin Manager",
