export default {
  ...
  TRANSACTION: {
    ...
    ERROR: {
      VALIDATION: {
        ...
        ENTITY_REGISTRATION: '{entity} Registration transaction could not be created',
        ENTITY_RESIGNATION: '{entity} Resignation transaction could not be created',
        ENTITY_UPDATE: '{entity} Update transaction could not be created'
      },
      ...
      BUSINESS_ENTITY_REGISTRATION: 'Business Registration could not be created',
      BUSINESS_ENTITY_RESIGNATION: 'Business Resignation could not be created',
      BUSINESS_ENTITY_UPDATE: 'Business Update could not be created',
      PRODUCT_ENTITY_REGISTRATION: 'Product Registration could not be created',
      PRODUCT_ENTITY_RESIGNATION: 'Product Resignation could not be created',
      PRODUCT_ENTITY_UPDATE: 'Product Update could not be created',
      PLUGIN_ENTITY_REGISTRATION: 'Plugin Registration could not be created',
      PLUGIN_ENTITY_RESIGNATION: 'Plugin Resignation could not be created',
      PLUGIN_ENTITY_UPDATE: 'Plugin Update could not be created',
      MODULE_ENTITY_REGISTRATION: 'Module Registration could not be created',
      MODULE_ENTITY_RESIGNATION: 'Module Resignation could not be created',
      MODULE_ENTITY_UPDATE: 'Module Update could not be created',
      DELEGATE_ENTITY_REGISTRATION: 'Delegate Entity Registration could not be created',
      DELEGATE_ENTITY_RESIGNATION: 'Delegate Entity Resignation could not be created',
      DELEGATE_ENTITY_UPDATE: 'Delegate Entity Update could not be created',
      UNDEFINED_REGISTRATION: 'Undefined Registration could not be created',
      UNDEFINED_RESIGNATION: 'Undefined Resignation could not be created',
      UNDEFINED_UPDATE: 'Undefined Update could not be created',
    ...
    SUCCESS: {
      ...
      BUSINESS_ENTITY_REGISTRATION: 'Business successfully registered',
      BUSINESS_ENTITY_RESIGNATION: 'Business successfully resigned',
      BUSINESS_ENTITY_UPDATE: 'Business successfully updated',
      PRODUCT_ENTITY_REGISTRATION: 'Product successfully registered',
      PRODUCT_ENTITY_RESIGNATION: 'Product successfully resigned',
      PRODUCT_ENTITY_UPDATE: 'Product successfully updated',
      PLUGIN_ENTITY_REGISTRATION: 'Plugin successfully registered',
      PLUGIN_ENTITY_RESIGNATION: 'Plugin successfully resigned',
      PLUGIN_ENTITY_UPDATE: 'Plugin successfully update',
      MODULE_ENTITY_REGISTRATION: 'Module successfully registered',
      MODULE_ENTITY_RESIGNATION: 'Module successfully resigned',
      MODULE_ENTITY_UPDATE: 'Module successfully updated',
      DELEGATE_ENTITY_REGISTRATION: 'Delegate Entity successfully registered',
      DELEGATE_ENTITY_RESIGNATION: 'Delegate Entity successfully resigned',
      DELEGATE_ENTITY_UPDATE: 'Delegate Entity successfully update',
      UNDEFINED_REGISTRATION: 'Entity successfully registered',
      UNDEFINED_RESIGNATION: 'Entity successfully resigned',
      UNDEFINED_UPDATE: 'Entity successfully update',
  ...
  ENTITY: {
    NO_ENTITIES_FOUND: 'No entities have been found. The latest entities will be displayed here.',
    OPEN_MSQ: 'Open MarketSquare',
