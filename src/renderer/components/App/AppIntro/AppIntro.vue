<template>
	...
	>
		<div class="flex w-full h-full top-0 left-0">
			...
			>
				<div slot="content">
					<i18n path="INTRODUCTION.WELCOME.TITLE" tag="div" class="font-bold mb-4">
			...
			<AppIntroScreen v-if="step === 1" :image="stepImage" @back="moveTo(0)" @next="moveTo(2)" @skip="done">
				<div slot="content">
			...
			<AppIntroScreen v-if="step === 2" :image="stepImage" @back="moveTo(1)" @next="moveTo(3)" @skip="done">
				<div slot="content">
					<div class="font-black text-3xl mb-5">
			...
			<AppIntroScreen v-if="step === 3" :image="stepImage" @back="moveTo(2)" @next="moveTo(4)" @skip="done">
				<div slot="content">
					<div class="font-black text-3xl mb-5">
						{{ $t("INTRODUCTION.RESPONSIBILITY.TITLE") }}
					</div>
					<i18n path="INTRODUCTION.RESPONSIBILITY.STORAGE.EXPLANATION" tag="p" class="mb-5">
						<span
						...
						<span
							...
							class="underline"
						/>
						<span v-t="'INTRODUCTION.RESPONSIBILITY.STORAGE.NEED'" place="NEED" class="font-bold" />
					</i18n>
			...
			<AppIntroScreen v-if="step === 4" :image="stepImage" @back="moveTo(3)" @next="done" @skip="done">
				<div slot="content">
					<div class="font-black text-3xl mb-5">
