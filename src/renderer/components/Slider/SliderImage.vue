<template>
	...
	>
		...
		>
			...
			>
				...
				>
					...
					>
						<div v-if="isRow" class="SliderImage__slide SliderImage__slide--row">
							<div
						...
						<img v-else :src="`data:image/png;base64,${images[index]}`" />
					</div>
				</transition-group>
			</div>
		...
		<slot :image-index="selectedImage" :close-image="closeImage" />
	</div>
</template>
