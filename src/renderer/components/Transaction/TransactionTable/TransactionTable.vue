	...
	<div class="TransactionTable w-full">
		...
		>
			<template slot-scope="data">
				...
				<div v-else-if="data.column.field === 'amount'" class="flex items-center justify-end">
					<span
						v-tooltip="{
				...
				<div v-else-if="data.column.field === 'asset.ipfs'" :class="{ 'dashboard-address': isDashboard }">
					<a
				...
				<span v-else :class="{ 'word-break-all': data.column.field === 'vendorField' }">
					{{ data.formattedRow[data.column.field] }}
				</span>
			</template>
		</TableWrapper>
