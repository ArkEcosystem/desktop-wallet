<template>
	<ListDivided class="TransactionConfirmBridgechainRegistration" :is-floating-label="true">
		<ListDividedItem
		...
		>
			<div v-for="(seedNode, id) of transaction.asset.bridgechainRegistration.seedNodes" :key="id">
				{{ seedNode }}
			</div>
		</ListDividedItem>
