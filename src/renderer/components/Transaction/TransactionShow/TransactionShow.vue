<template>
	<ModalWindow :title="$t('TRANSACTION.TRANSACTION')" container-classes="TransactionShow" @close="emitClose">
		<ListDivided>
			...
			<ListDividedItem :label="$t('TRANSACTION.CONFIRMATIONS')" item-value-class="flex items-center">
		...
		<div v-show="transaction.isExpired">
			...
			<ButtonGeneric :label="$t('TRANSACTION.DISCARD')" class="ml-4" @click="emitDiscard" />
		</div>
	</ModalWindow>
</template>
