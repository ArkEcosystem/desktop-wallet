<template>
	<form class="TransactionFormDelegateRegistration flex flex-col" @submit.prevent>
		<template v-if="!currentWallet.isDelegate">
			...
			<div v-if="!isMultiSignature">
				<div v-if="currentWallet.isLedger" class="TransactionFormDelegateRegistration__ledger-notice mt-10">
