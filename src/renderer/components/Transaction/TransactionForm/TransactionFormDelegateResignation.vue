<template>
	<form class="TransactionFormDelegateResignation flex flex-col" @submit.prevent>
		<template v-if="canResign">
			...
			<div v-if="!isMultiSignature">
				<div v-if="currentWallet.isLedger" class="TransactionFormDelegateResignation__ledger-notice mt-10">
