<template>
	<form class="TransactionFormBusinessResignation flex flex-col" @submit.prevent>
		<template v-if="canResignBusiness">
			...
			<div v-if="!isMultiSignature">
				<div v-if="currentWallet.isLedger" class="TransactionFormBusinessResignation__ledger-notice mt-10">
				...
				<InputPassword
					...
					:is-required="true"
					class="TransactionFormBusinessResignation__password mt-4"
				/>
				...
				<PassphraseInput
					...
					class="TransactionFormBusinessResignation__passphrase mt-4"
				/>
			</div>
