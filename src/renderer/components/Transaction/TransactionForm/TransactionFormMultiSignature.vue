<template>
	<form class="TransactionFormMultiSignature flex flex-col" @submit.prevent>
		...
		<div v-if="step === 1" class="TransactionFormMultiSignature__step-1">
			<MenuTab ref="menutab" v-model="currentTab" class="TransactionModalMultiSignature__menu-tabs">
				<MenuTabItem
			...
			<div class="flex flex-row">
				...
				<div v-else-if="publicKeyTab" class="flex-1">
					<InputPublicKey
						ref="publicKey"
...
import { InputAddress, InputFee, InputPassword, InputPublicKey, InputText } from "@/components/Input";
