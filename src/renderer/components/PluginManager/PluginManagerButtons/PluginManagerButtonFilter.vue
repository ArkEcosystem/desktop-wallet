<template>
	<div v-click-outside="closeDropdown">
		<button class="PluginManagerButtonFilter" @click="toggleDropdown">
			<span class="mr-2 md:whitespace-no-wrap">
				{{ strings_capitalizeFirst($t(`PAGES.PLUGIN_MANAGER.FILTERS.${activeFilter.toUpperCase()}`)) }}
			</span>

			<SvgIcon :class="{ 'rotate-180': isOpen }" name="arrow-dropdown" view-box="0 0 10 10" />
		</button>

		<div v-show="isOpen" class="PluginManagerButtonFilter__options">
			<div
