<template>
	<div class="PluginManagerGrid mt-10">
		<div v-for="plugin in sortedPlugins" :key="plugin.id" class="PluginManagerGrid__plugin">
			<div class="flex">
				...
				<div class="pl-4">
					<div class="flex flex-col justify-center h-20">
						<div class="flex items-center">
							<span class="PluginManagerGrid__plugin__name" @click="emitShowDetails(plugin)">
								{{ plugin.title }}
							</span>
