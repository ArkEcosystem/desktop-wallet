<template>
	<ModalWindow :message="$t('PAGES.PLUGIN_MANAGER.DISCLAIMER')" container-classes="max-w-md" @close="emitClose">
		<template #default>
			<section class="PluginInstallModal__authorized">
				<img :src="installImage" class="PluginInstallModal__authorized__image" />

				<div class="PluginInstallModal__authorized__downloading">
			...
			<footer v-if="!isDownloadFailed" class="PluginInstallModal__footer">
