<template>
	<ModalConfirmation
		:question="
			wallet.isContact
				? $t('WALLET_REMOVAL_CONFIRMATION.CONTACT_QUESTION')
				: $t('WALLET_REMOVAL_CONFIRMATION.QUESTION')
		"
	...
	>
		<div class="flex flex-row justify-center">
			...
			/>
			<WalletIdenticon :value="wallet.address" :size="150" class="WalletHeading__identicon" />
			<img
				:title="wallet.name"
				:src="assets_loadImage('arrows/arrow-confirmation.svg')"
