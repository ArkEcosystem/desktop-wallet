<template>
	<div class="WalletGrid mt-10">
		<button v-if="isLedgerLoading" :disabled="true" class="WalletGrid__wallet">
			<Loader />
				...
				<div class="WalletGrid__wallet__wrapper__mask">
					<div class="flex items-center justify-between">
						<div class="flex items-center">
							<WalletIdenticon :value="wallet.address" :size="60" class="identicon" />
						...
						<div class="flex items-center">
							...
							>
								...
								>
									<SvgIcon name="more" view-box="0 0 5 15" class="text-inherit" />
								</span>
