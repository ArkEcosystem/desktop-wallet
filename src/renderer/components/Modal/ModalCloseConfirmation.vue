<template>
	<div class="ModalCloseConfirmation ModalCloseConfirmation__mask" @click="onBackdropClick">
		<div class="ModalCloseConfirmation__container" @click.stop="void 0">
			<section class="ModalCloseConfirmation__container__content">
				<div class="mb-6">
					...
					<div v-if="note" class="mt-3 text-grey-darker text-lg" :class="{ 'mb-8': note }">
						{{ note }}
					</div>
				</div>
				...
				<div class="mt-4 flex flex-row">
					<div class="flex-1">
						<button class="ModalCloseConfirmation__cancel-button blue-button m-1" @click="emitCancel">
							{{ cancelButton }}
						</button>
					</div>
