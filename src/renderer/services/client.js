...
export default class ClientService {
	...
	static async fetchFeeStatistics(server, timeout) {
		...
		try {
			const response = await ClientService.newConnection(server, timeout).api("node").fees(7);
    ...
    */
	...
	async fetchBusinessBridgechains(address, options = {}) {
		...
		return (
			await this.client.api("businesses").bridgechains(address, {
				page: options.page,
				limit: options.limit,
				orderBy: options.orderBy,
			})
	...
	// todo: move this out
	async buildSecondSignatureRegistration(data, isAdvancedFee = false, returnObject = false) {
		return this.__buildTransaction("buildSecondSignatureRegistration", data, isAdvancedFee, returnObject);
	}

	// todo: move this out
	async buildDelegateRegistration(data, isAdvancedFee = false, returnObject = false) {
	...
	// todo: move this out
	async buildDelegateResignation(data, isAdvancedFee = false, returnObject = false) {
		return this.__buildTransaction("buildDelegateResignation", data, isAdvancedFee, returnObject);
	}

	// todo: move this out
	async buildBusinessRegistration(data, isAdvancedFee = false, returnObject = false) {
	...
	// todo: move this out
	async buildBusinessResignation(data, isAdvancedFee = false, returnObject = false) {
		return this.__buildTransaction("buildBusinessResignation", data, isAdvancedFee, returnObject);
	}

	// todo: move this out
	async buildBridgechainRegistration(data, isAdvancedFee = false, returnObject = false) {
		return this.__buildTransaction("buildBridgechainRegistration", data, isAdvancedFee, returnObject);
	}

	// todo: move this out
	async buildBridgechainUpdate(data, isAdvancedFee = false, returnObject = false) {
		return this.__buildTransaction("buildBridgechainUpdate", data, isAdvancedFee, returnObject);
	}

	// todo: move this out
	async buildBridgechainResignation(data, isAdvancedFee = false, returnObject = false) {
