...
export default class DesktopWallet extends Vue {
	...
	onHasScreenshotProtectionChanged(value) {
		// @ts-ignore
	...
	onCurrentProfileIdChanged(value, oldValue) {
		if (value && oldValue) {
