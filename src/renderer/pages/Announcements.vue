<template>
  <div class="relative overflow-y-auto bg-theme-feature rounded-lg m-r-4">
    <div class="gradient-top sticky pin-t h-12"/>
      ...
      >
        ...
        >
          ...
          <div
            ...
            class="line-separator mt-6"
          />
        </div>
      </transition-group>
    </main>

    <div class="gradient-bottom sticky pin-b h-12"/>
  </div>
</template>
...
import Post from '@/components/announcements/Post'
