	...
	<div class="NetworkOverview relative">
		<main class="flex h-full">
			...
			<div class="flex-none w-full lg:max-w-sm bg-theme-feature rounded-lg overflow-y-auto">
				<button class="NetworkOverview__network flex items-center w-full" @click="openAddNetwork">
				...
				>
					...
					<span class="p-2 hidden md:inline-block">
						<SvgIcon name="settings-filled" view-box="0 0 23 23" class="text-theme-feature-item-text" />
					</span>
					<NetworkModal
