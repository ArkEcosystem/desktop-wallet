      ...
      >
        ...
        >
          ...
          <p v-else class="text-center py-2 leading-normal">
            {{
              $t(`PAGES.WALLET_NEW.STEP${step}.INSTRUCTIONS.TEXT`, {
                words: wordPositionLabel
              })
            }}
          </p>
        ...
        <MenuStep :step="step">
          ...
          >
            ...
            >
              ...
              >
                <div
                  class="WalletNew__wallets__address__mask flex items-center"
                >
                  <div class="relative">
                    <WalletIdenticon
                      :value="address"
            ...
            <div class="flex flex-col h-full w-full justify-around">
              <div class="flex items-center justify-between mt-4">
                <div class="flex flex-col">
                  ...
                  <span
                    class="text-sm text-theme-page-text-light font-semibold mt-1"
                  >
  ...
  computed: {
    ...
    wordPositionLabel () {
      return this.ensureEntirePassphrase
        ...
        : this.$t('PAGES.WALLET_NEW.STEP3.INSTRUCTIONS.WORDS', {
            words: this.wordPositions.join(', ')
          })
    },
    nameError () {
