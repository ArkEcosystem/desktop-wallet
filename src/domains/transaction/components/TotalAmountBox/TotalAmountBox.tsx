...
export const TotalAmountBox = ({ amount, fee, ticker }: Props) => {
	...
	return (
		<div className="border rounded-lg border-theme-secondary-300 dark:border-theme-secondary-800">
			...
			<div className="flex flex-col items-center py-6 border-t rounded-b-lg border-theme-secondary-300 dark:border-theme-secondary-800 justfiy-center bg-theme-secondary-100 dark:bg-theme-secondary-800">
