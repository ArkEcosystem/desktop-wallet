...
import { PasswordType } from "./SendEntityResignation.models";
...
export const ThirdStep = ({ form, passwordType }: { form: any; passwordType: PasswordType }) => {
	...
	return (
		<div data-testid="SendEntityResignation__third-step">
			{passwordType !== "ledger" && (
				<div>
					...
					<div className="mt-8">
						<FormField name={passwordType}>
							...
							<InputPassword
								data-testid={`SendEntityResignation__${passwordType}`}
								name={passwordType}
								ref={register}
