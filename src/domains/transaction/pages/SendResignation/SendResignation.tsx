...
export const SendResignation = ({ formDefaultData }: any) => {
	...
	const [state, setState] = useState<{ type?: string }>({ type: "delegate" });
										...
										<div className="flex justify-end mt-10 space-x-3">
											{activeTab < 4 && (
												<Button
													...
													data-testid="SendResignation__back-button"
													variant="secondary"
													onClick={handleBack}
												>
													{t("COMMON.BACK")}
											...
											{activeTab < 3 && (
												<Button
													data-testid="SendResignation__continue-button"
													disabled={!isValid}
													onClick={handleNext}
												>
													{t("COMMON.CONTINUE")}
											...
											{activeTab === 3 && (
												<Button
													type="submit"
													data-testid="SendResignation__send-button"
													disabled={!isValid}
													className="space-x-2"
												>
											...
											{activeTab === 4 && (
												<div className="flex justify-end space-x-3">
													<Button
														data-testid="SendResignation__wallet-button"
														variant="secondary"
														onClick={() => {
													...
													<Button
														data-testid="SendResignation__download-button"
														variant="secondary"
														className="space-x-2"
													>
														<Icon name="Download" />
