...
describe("SendResignation", () => {
	...
	describe("Entity Resignation", () => {
		...
		it("should render 1st step as entity", async () => {
			...
			await waitFor(() => expect(getByTestId("SendResignation__form-step")).toBeTruthy());
		...
		it("should render 2nd step as entity", async () => {
			...
			await act(async () => {
				fireEvent.click(getByTestId("SendResignation__continue-button"));
			});

			expect(getByTestId("SendResignation__review-step")).toBeTruthy();
			expect(asFragment()).toMatchSnapshot();
		});
		...
		it("should successfully sign and submit an entity resignation transaction", async () => {
			...
			act(() => {
				fireEvent.click(getByTestId("SendResignation__send-button"));
			});

			await waitFor(() => expect(getByTestId("SendResignation__summary-step")).toBeTruthy());
			expect(asFragment()).toMatchSnapshot();
	...
	describe("Delegate Resignation", () => {
		...
		it("should navigate between 1st and 2nd step", async () => {
			...
			act(() => {
				fireEvent.click(getByTestId("SendResignation__back-button"));
			});
		...
		it("should show mnemonic authentication error", async () => {
			...
			await waitFor(() => expect(getByTestId("SendResignation__send-button")).toBeDisabled());
		...
		// 	act(() => {
		// 		fireEvent.click(getByTestId("SendResignation__download-button"));
		// 	});
		...
		it("should back button after successful submission", async () => {
			...
			act(() => {
				fireEvent.click(getByTestId("SendResignation__wallet-button"));
			});
