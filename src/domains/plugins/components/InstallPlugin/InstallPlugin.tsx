...
export const InstallPlugin = ({ step, isOpen, onClose, onCancel }: Props) => {
	return (
			...
			<div className="container">
				{step === 1 && (
					<>
						...
						<ul className="mt-2 text-sm list-inside leading-8 list-circle text-theme-neutral-dark md:text-base">
