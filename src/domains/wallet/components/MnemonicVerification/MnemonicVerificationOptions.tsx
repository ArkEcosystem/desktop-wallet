...
export const OptionButton = styled(motion.button)`
	${tw`font-medium rounded-lg transition-colors duration-100 border-2 border-theme-primary-100 dark:border-theme-neutral-800 p-3 focus:outline-none focus:shadow-outline hover:border-theme-primary-200 hover:dark:border-theme-neutral-700`}
