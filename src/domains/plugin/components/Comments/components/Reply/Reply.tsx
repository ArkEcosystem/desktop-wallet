...
export const Reply = ({ date, content }: ReplyProps) => {
	...
	return (
		<div className="flex flex-col mt-3">
			<div className="flex items-center text-theme-secondary-400">
				<div className="flex items-center w-10">
					<Icon className="mx-auto -mt-2" name="ReplyArrow" width={15} height={18} />
				</div>

				<div className="flex items-center space-x-3 divide-x divide-theme-secondary-400">
			...
			<ReplyContent
				className="mt-2 ml-10 text-theme-secondary-600"
