...
describe("MnemonicVerificationOptions", () => {
    ...
    it("should render options", () => {
        ...
        const { getAllByTestId } = render(<MnemonicVerificationOptions handleChange={handleChange} options={options} answer={answer} limit={limit} position={1} />);
    ...
    it("should call handle on click", () => {
        const handleChange = jest.fn();
        const { getByText } = render(<MnemonicVerificationOptions handleChange={handleChange} options={options} answer={answer} limit={limit} position={1} />);
