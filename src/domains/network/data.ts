...
export const availableNetworksMock: Coins.Network[] = [
	...
	new Coins.Network(AVAX.manifest.networks["avax.mainnet"]),
	new Coins.Network(AVAX.manifest.networks["avax.testnet"]),
	new Coins.Network(BTC.manifest.networks["btc.livenet"]),
	new Coins.Network(BTC.manifest.networks["btc.testnet"]),
	new Coins.Network(DOT.manifest.networks["dot.mainnet"]),
	new Coins.Network(DOT.manifest.networks["ksm.mainnet"]),
	...
	new Coins.Network(LUNA.manifest.networks["luna.mainnet"]),
	new Coins.Network(LUNA.manifest.networks["luna.testnet"]),
	new Coins.Network(NANO.manifest.networks["nano.mainnet"]),
	new Coins.Network(NANO.manifest.networks["nano.testnet"]),
