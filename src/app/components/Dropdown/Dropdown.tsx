	...
	return (
		<ul data-testid="dropdown__options">
			{(options as DropdownOption[]).map((option: DropdownOption, index: number) => (
				<li
					className="block py-4 px-8 text-base font-semibold text-left whitespace-nowrap cursor-pointer text-theme-neutral-800 dark:text-theme-neutral-200 hover:bg-theme-neutral-200 dark:hover:bg-theme-primary-600 hover:text-theme-primary-600 dark:hover:text-theme-neutral-200"
					key={index}
