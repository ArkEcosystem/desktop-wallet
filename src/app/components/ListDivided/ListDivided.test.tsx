...
describe("ListDivided", () => {
	...
	it("should render an list divided with items", () => {
		const item = {
			...
			itemLabelDescriptionClass: "text-sm font-semibold text-theme-neutral-700",
			labelClass: "",
			value: "",
			itemValueClass: "",
			content: (
				<div className="flex flex-row mt-2">
					<div className="flex justify-center items-center mr-6 w-24 h-24 rounded border-2 border-dashed border-theme-neutral-500" />
					<div className="relative w-24 h-24 rounded bg-theme-neutral-500">
						<img
