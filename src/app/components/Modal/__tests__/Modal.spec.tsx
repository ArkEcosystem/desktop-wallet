...
describe("Modal", () => {
	...
	it("should render a modal with overlay", () => {
		const { asFragment, getByTestId } = render(<Modal title="ark" isOpen={true}>This is the Modal content</Modal>);
	...
	it("should render a modal with description", () => {
		const { asFragment, getByTestId } = render(<Modal title="ark" description="This is the Modal description" isOpen={true} />);
